...
class TransferBankBca extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->icon                      = TIKSTORE_URL . '/img/payments/bca.png';
