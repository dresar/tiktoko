...
class TransferBankBsi extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->icon                      = TIKSTORE_URL . '/img/payments/bsi.png';
