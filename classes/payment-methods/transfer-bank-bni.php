...
class TransferBankBni extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->icon                      = TIKSTORE_URL . '/img/payments/bni.png';
